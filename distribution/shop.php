              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  ...
                  <?php
                    ...
                    $total_pages = 5;
                      ...
                      $selectPro = "SELECT * FROM `products` LIMIT $products_per_page OFFSET $offset";
                      $queryPro = $conn -> query($selectPro);
                      foreach ($queryPro as $item) {
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        $selectImg = "SELECT * FROM images WHERE product_id = $productId";
                        $queryImg = $conn -> query($selectImg);
                        foreach ($queryImg as $res) {
                          ?>
                          <img class="img-fluid w-100" src="../admin/img/<?= $res['img'] ;?>" alt="..."></a>
                          <?php } ?>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="functionDis/addCart.php?id=<?= $item['id'] ?>">Add to cart</a></li>
                            <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark" href="#productView" data-toggle="modal"><i class="fas fa-expand"></i></a></li>
                          </ul>
                        </div>
                      </div>
                      <h6> <a class="reset-anchor" href="detail.php"><?= $item['name'] ?></a></h6>
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-center justify-content-lg-end">
                    <li class="page-item"><a class="page-link" href="shop.php?page=<?= $current_page - 1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                    ...
                    <li class="page-item"><a class="page-link" href="shop.php?page=<?= $current_page + 1 ?>" aria-label="Next"><span aria-hidden="true">»</span></a></li>
                    <?php endif; ?>
                  </ul>
                </nav>
              </div>
