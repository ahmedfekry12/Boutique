          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="font-weight-bold text-uppercase text-dark">Boutique</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ml-auto">               
                ...
                <li class="nav-item"><a class="nav-link" href="register.php"> <i class="fas fa-user-alt mr-1 text-gray"></i>Register</a></li>
              </ul>
            </div>
          </nav>
        </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-5 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4">
                      ...
                      <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="functionDis/addCartForm.php">Add to cart</a></div>
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <div class="product-overlay">
                    ...
                    <input type="hidden" name="pro_id" value="3">
                    <ul class="mb-0 list-inline">
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="functionDis/addCart.php?id=<?= $product['id'] ?>">Add to cart</a></li>
              ...
              <div class="product text-center">
                <div class="position-relative mb-3">
                  ...
                  <div class="product-overlay">
                    <ul class="mb-0 list-inline">
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                      <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="functionDis/addCartForm.php">Add to cart</a></li>
                      <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark" href="#productView" data-toggle="modal"><i class="fas fa-expand"></i></a></li>
                    </ul>
                  </div>
                </div>
